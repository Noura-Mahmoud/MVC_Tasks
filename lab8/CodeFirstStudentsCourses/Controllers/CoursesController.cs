...
namespace CodeFirstStudentsCourses.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            var studentsDbContext = _context.Courses.Include(c => c.Student);
        ...
        public async Task<IActionResult> Create([Bind("ID,Topic,CourseGrade,StudentID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Topic,CourseGrade,StudentID")] Course course)
        {
            if (id != course.ID)
            {
                return NotFound();
